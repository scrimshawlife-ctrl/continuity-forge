# Bundled implementation for standalone skill use (when kubrick-helpers extra is not installed).
# This is the original logic extracted for fallback compatibility.
# When the optional extra is installed, the thin wrapper above uses the packaged version instead.
